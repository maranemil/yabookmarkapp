...
--
-- Host: localhost
-- Erstellungszeit: 07. Sep 2021 um 17:47
...
--
ALTER TABLE `bookmarks`
  MODIFY `bookmarks_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=567;
...
--
ALTER TABLE `favourites`
  MODIFY `favourites_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
